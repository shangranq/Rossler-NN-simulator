...
The first model contained in the repo is Multilayer perceptron (MLP). The configuration of the MLP model can be changed in the config.json file. 

<p align="center">
  <img src="plots/MLP.png", width="300"/>
</p>

The MLP model was trained only to predict the x coordinate from a window of previous x coordinates. Mean Square Error (MSE) on the testing part is 0.0098. To visualize the model's performance, long term prediction was generated by the strategy of sliding window, i.e., incorporate the predicted x on the newest time point and slide the window one step forward. 

<p align="center">
  <img src="plots/MLP_x/long_test_window_400.jpg", width="1000"/>
</p>
